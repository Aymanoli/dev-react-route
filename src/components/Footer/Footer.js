                        ...
                        <Col>
                            <div className="text-center">
                                ...
                                <div className="footer-icon">
                                    ...
                                    <a target="_blank" rel="noreferrer" href="https://github.com"><i className="fab fa-github"></i></a>
                                </div>
